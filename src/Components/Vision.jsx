  ...
  const visions = [
    {
      ...
      title: "Seminar",
      image:
        "https://medschool.vanderbilt.edu/wp-content/uploads/sites/35/public_files/13314405705_fa3a6e6850_k.jpg", //input the images url here
    ...
    },
    {
      ...
      title: "Projects",
      image:
        "https://www.thebvnewspaper.com/wp-content/uploads/2021/04/Group-Projects.jpg", //input the images url here
    ...
    },
    {
      ...
      title: "Workshop",
      image:
        "https://studio180theatre.com/wp-content/uploads/2023/08/Studio-180-Education-Workshop-68-1-1200x801.jpg", //input the images url here
    ...
    },
    {
      ...
      title: "Hackathons",
      image:
        "https://www.coresponsibility.com/wp-content/uploads/2016/03/cr-students-hack.jpg", //input the images url here
          ...
          {visions.map(({ id, title, description, classes, image }) => (
            ...
            >
              <div className="my-4 mx-4 d-flex flex-column ">
                ...
                {/* Redirect Button */}
                <span
                  className={`vision_card__title fw-bold text-white rounded p-2 w-75 my-4 px-3 ${classes} mx-auto`}
                >
                  {title}
                </span>
              </div>
