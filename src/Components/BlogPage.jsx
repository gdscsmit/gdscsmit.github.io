...
export default function BlogPage() {
  return (
    <>
      <Navbar />
      <div className="text-center my-4 display-5">
        <img src="./img/dsc.ico" alt="" width={60} />
        &nbsp;Our Blogs&nbsp;
        <img src="./img/dsc.ico" alt="" width={60} />
      </div>
      <div className="container blogPage row mx-auto">
        <section
          className="mx-auto my-5 col-sm-6"
          ...
          <div className="card testimonial-card mt-2 mb-3">
            ...
            <div className="card-body text-center">
              ...
              <p>
                ...
                amet, consectetur adipisicing elit. Eos, adipisci
              </p>
            </div>
          </div>
        </section>
