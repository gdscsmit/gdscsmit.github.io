...
// get random border and background color
...
export default function Team() {
  ...
  // filter team members based on domain
        ...
        <>
          ...
          <div className="my-5 w-75 mx-auto">
            <div className="d-flex flex-column justify-center">
              ...
              <p className="text-2xl text-center max-w-lg md:max-w-2xl">
                Learning and innovation are at the core of everything we do.
                With our extraordinary team, we are dedicated to solving
                everyday challenges and pushing the boundaries of technology.
          ...
          <div className="container ">
            ...
            <div className="container my-5">
              <ul
                className="nav nav-pills d-flex justify-content-center border border-dark p-3"
                id="domainTabs"
              >
                {/* Render all the unique domains */}
            ...
            `}
              ...
              <div className="tab-content" id="domainTabsContent">
                {/*  Render all the team members based on domain */}
                {uniqueDomains.map((domain) => (
                  <div
                    key={domain}
                    className={`tab-pane fade ${
                      domain === activeDomain ? "show active" : ""
                    }`}
                  >
                    <CardList
                      teamData={filterTeamMembers(CoreTeamData, domain)}
                    />
                  </div>
                ))}
              </div>
